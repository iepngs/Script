...
function qktx_user(r) {
    ...
    var result2 = "";
    const llUrl1 = { 
        url: "https://appv7.qukantx.com/user/userPoint.do?bundleId=com.qktx.discovery&" + qktx_userck, 
        headers: { "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NetType/4G Qktx" }, 
        timeout: 60
    };
    ...
    $iosrule.get(llUrl1, function (error, response, data) {
        ...
        if (data != null) {
            ...
            result2 = "[总/今💰]" + "获取错误❌" + "🕰获取错误❌"; qktx_nm = "昵称获取错误❌"; 
        }
...
function qktx_task_youjiangfenxiang() {
    ...
    var result2 = "";
    const llUrl1 = { 
        url: "https://appv8.qukantianxia.com/qktx-activity/userShareTask/addAwardShareCount?" + qktx_urlck, 
        headers: { "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NetType/4G Qktx" }, 
        timeout: 60 
    };
...
function qktx_task_art() {
    ...
    var result2 = "";
    const llUrl1 = { 
        url: "https://appv7.qukantx.com/task/getTaskShareInfo.do?bundleId=com.qktx.discovery&" + qktx_urlck, 
        headers: { "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NetType/4G Qktx" }, 
        timeout: 60 
    };
    $iosrule.get(llUrl1, function (error, response, data) { })
...
function qktx_daytask() {
    ...
    var result2 = "";
    const llUrl1 = { 
        url: "https://appv8.qukantianxia.com/qktx-activity/activity/getEverydayTasks?" + qktx_urlck, 
        headers: { "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NetType/4G Qktx" }, 
        timeout: 60 
    };
...
function qktx_getTaskAward(flag) {
    ...
    const llUrlts = { 
        url: "https://appv8.qukantianxia.com/qktx-activity/activity/getTaskAward?" + zhuanfa + aFlag, 
...
function qktx_daysign() {
    ...
    var result2 = "";
    const llUrl1 = { 
        url: "https://appv8.qukantianxia.com/qktx-activity/activity/userSign?" + qktx_urlck, 
        headers: { "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NetType/4G Qktx" }, 
        timeout: 60
    };
...
function qktx_cxdaysign(r) {
    ...
    var result2 = "";
    const llUrl1 = { 
        url: "https://appv8.qukantianxia.com/qktx-activity/activity/getSignDetail?" + qktx_urlck, 
        headers: { "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NetType/4G Qktx" }, 
        timeout: 60
    };
    ...
    $iosrule.get(llUrl1, function (error, response, data) {
        if (data != null) {
            ...
            var obj = JSON.parse(data);
            if (obj.result == 1) { r += " [天数]" + obj.data.signTotalNum; }
        }
        else r += " [天数]" + "获取错误❌";
...
function htt_bestread2(flag, l, sb) {
    const llUrl1 = { 
        url: "https://appv8.qukantianxia.com/qktx-content/addTaskRead?" + qktx_urlck + "&cs=" + l + "&articleType=1&touchCount=36&shareCount=2", 
        headers: { "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NetType/4G Qktx" }, 
        timeout: 60
    };
    $iosrule.get(llUrl1, function (error, response, data) { })
...
function htt_bestread4(flag, sb) {
    ...
    const llUrl1 = { 
        url: "https://appv7.qukantx.com/addCoin.json?" + qktx_urlrck, 
        headers: { "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NetType/4G Qktx" }, 
        timeout: 6000000
    };
...
function htt_getarticle() {
    const llUrl1 = { 
        url: "https://appv8.qukantianxia.com/qktx-content/task/getArticleRelationList?" + qktx_urlck + "&articleType=1", 
        headers: { "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NetType/4G Qktx" }, 
        timeout: 60 
    };
    $iosrule.get(llUrl1, function (error, response, data) {
...
function qktx_msg(r, s) {
    ...
    if (qktx_num == qktx_ttnum) {
        ...
        if (typeof (loon) != "undefined") {
            ...
            loon++;
            if (log == 1) console.log("趣看天下第" + loon + "次运行完毕。"); $iosrule.write("iosrule" + loon, "iosrule_qktx");
        } else {
            loon = 1;
