...
function hammer(t="untitled", l=3){
    ...
    return new class{
        ...
        log(...n){
            ...
            console.log(`\n*********** ${this.name} ***********`);
            for (let i in n) console.log(typeof n[i] == "object"?eval(`(${JSON.stringify(n[i])})`):n[i]);
        }
        ...
        async request(method, params, callback){
            ...
            if(!options.headers || !Object.keys(options.headers).includes("User-Agent")){
